...
- MCTS: "MCTS framework (Sun 2025) ... incurs significant overhead" — 명명된 선행 접근의 단점을 짚고 RL로 넘어섬(improve upon).
- 제외: Qwen-2.5-7B-Instruct(실험 substrate일 뿐 "딛/보강" 아님), R1-Searcher·Search-R1(본문 미호명, 인용·URL뿐), SFT(일반 학습방식+자기 단계로도 사용).
